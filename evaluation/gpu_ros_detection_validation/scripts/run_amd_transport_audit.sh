...
ros2 run gpu_ros_onnx_inference summarize_ort_profile.py \
...
ros2 run gpu_ros_onnx_inference analyze_rocprof_traces.py \
...

{
  ...
  echo "Direct Managed HIP production lane expects no application TensorBundle staging copies."
