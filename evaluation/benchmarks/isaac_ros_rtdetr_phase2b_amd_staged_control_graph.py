...
RESULTS_FILE = os.environ.get("R2B_RESULT_FILE") or (
    "isaac_ros_rtdetr_phase2b_amd_staged_control.json")


def launch_setup(container_prefix, container_sigterm_timeout):
    """Build the RT-DETR staged-control graph."""
    namespace = TestIsaacROSRtDetrPhase2bAmdStagedControl.generate_namespace()
    model_path = os.path.join(
        TestIsaacROSRtDetrPhase2bAmdStagedControl.get_assets_root_path(),
...
def generate_test_description():
    ...
    return TestIsaacROSRtDetrPhase2bAmdStagedControl.generate_test_description_with_nsys(
        launch_setup)
