...
RESULTS_FILE = os.environ.get("R2B_RESULT_FILE") or (
    "isaac_ros_yolov8_phase2b_amd_managed.json")
...
def launch_setup(container_prefix, container_sigterm_timeout):
    ...
    namespace = TestIsaacROSYoloV8Phase2bAmdManaged.generate_namespace()
    model_path = model_path_for_test(TestIsaacROSYoloV8Phase2bAmdManaged)
...
def generate_test_description():
    ...
    return TestIsaacROSYoloV8Phase2bAmdManaged.generate_test_description_with_nsys(
        launch_setup)


class TestIsaacROSYoloV8Phase2bAmdManaged(ROS2BenchmarkTest):
