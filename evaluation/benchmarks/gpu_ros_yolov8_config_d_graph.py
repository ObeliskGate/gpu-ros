...
"""Config D benchmark: ONNX Runtime CUDA + standard TensorBundle + std YOLOv8 decoder."""
...
def generate_test_description():
    return TestGpuRosYoloV8ConfigD.generate_test_description_with_nsys(launch_setup)


class TestGpuRosYoloV8ConfigD(ROS2BenchmarkTest):
    """Config D: ONNX Runtime CUDA + standard TensorBundle + std YOLOv8 decoder."""

    config = ROS2BenchmarkConfig(
        benchmark_name='GPU ROS YOLOv8 (NVIDIA reference D: ORT + std ROS2)',
