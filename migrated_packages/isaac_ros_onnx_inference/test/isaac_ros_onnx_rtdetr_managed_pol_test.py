...
_POL_MODULE_PATH = pathlib.Path(__file__).with_name('isaac_ros_onnx_rtdetr_pol_test.py')
_POL_SPEC = importlib.util.spec_from_file_location('isaac_ros_onnx_rtdetr_pol_test',
                                                   _POL_MODULE_PATH)
...
IsaacROSOnnxRtDetrPOLTest = _POL_MODULE.IsaacROSOnnxRtDetrPOLTest
