...
case "${MODEL}" in
  yolov8)
    GRAPH_STD="isaac_ros_yolov8_phase2a_amd_graph.py"
    GRAPH_STAGED="isaac_ros_yolov8_phase2b_amd_staged_control_graph.py"
    GRAPH_DIRECT="isaac_ros_yolov8_phase2b_amd_managed_graph.py"
    ;;
  rtdetr)
    GRAPH_STD="isaac_ros_rtdetr_phase2a_amd_graph.py"
    GRAPH_STAGED="isaac_ros_rtdetr_phase2b_amd_staged_control_graph.py"
    GRAPH_DIRECT="isaac_ros_rtdetr_phase2b_amd_managed_graph.py"
    ;;
  *)
