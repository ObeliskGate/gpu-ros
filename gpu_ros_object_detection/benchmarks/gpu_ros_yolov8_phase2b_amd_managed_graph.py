...
RESULTS_FILE = os.environ.get("R2B_RESULT_FILE") or ("gpu_ros_yolov8_phase2b_amd_managed.json")
...
def generate_test_description():
    ...
    return TestGpuRosYoloV8Phase2bAmdManaged.generate_test_description_with_nsys(launch_setup)
...
class TestGpuRosYoloV8Phase2bAmdManaged(ROS2BenchmarkTest):
    ...
    config = ROS2BenchmarkConfig(
        benchmark_name=("GPU ROS YOLOv8 Phase 2B AMD (ORT MIGraphX + Managed HIP)"),
